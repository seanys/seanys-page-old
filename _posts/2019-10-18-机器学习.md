...
![img](https://pic2.zhimg.com/80/v2-dc2ac40390791ca7f0ccf53cee0d4881_hd.png)
...
![img](https://pic1.zhimg.com/80/v2-577bb114a1073273452cc1c73045e274_hd.png)
...
![img](https://pic1.zhimg.com/80/v2-27f8c5989dd7790ccf6b626e6854e06c_hd.png)
...
![img](https://pic1.zhimg.com/80/v2-c6a79e230f946da8aefd793ed57c0454_hd.png)

![[公式]](https://www.zhihu.com/equation?tex=y_i)比起test set approach，LOOCV有很多优点。首先它不受测试集合训练集划分方法的影响，因为每一个数据都单独的做过测试集。同时，其用了n-1个数据训练模型，也几乎用到了所有的数据，保证了模型的bias更小。不过LOOCV的缺点也很明显，那就是计算量过于大，是test set approach耗时的n-1倍。
...
其中![[公式]](https://www.zhihu.com/equation?tex=%5Chat%7By_i%7D)![[公式]](https://www.zhihu.com/equation?tex=h_i)![[公式]](https://www.zhihu.com/equation?tex=h_i)
...
![img](https://pic4.zhimg.com/80/v2-fcb843dd06c15a515d03a543864bbb77_hd.png)
...
![img](https://pic2.zhimg.com/80/v2-daf077823e7faa57c6f4014389fe12b9_hd.png)
...
![img](https://pic3.zhimg.com/80/v2-7302b5c15dcfc6746b51830b65debf62_hd.png)

其中Erri表示的是第i个模型在第i组测试集上的分类错误的个数。

原文：https://zhuanlan.zhihu.com/p/24825503
